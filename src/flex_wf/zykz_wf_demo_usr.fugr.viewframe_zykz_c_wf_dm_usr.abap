*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZYKZ_C_WF_DM_USR
*   generation date: 12.07.2021 at 22:15:06
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZYKZ_C_WF_DM_USR    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZYKZ_C_WF_DM_USR'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZYKZ_C_WF_DM_USR_EXTRACT
TOTAL = ZYKZ_C_WF_DM_USR_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZYKZ_C_WF_DM_USR'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZYKZ_C_WF_DM_USR-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZYKZ_C_WF_DM_USR_EXTRACT
TOTAL = ZYKZ_C_WF_DM_USR_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZYKZ_C_WF_DM_USR-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZYKZ_C_WF_DM_USR'
...
TOTAL = ZYKZ_C_WF_DM_USR_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZYKZ_C_WF_DM_USR-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZYKZ_C_WF_DM_USR-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZYKZ_C_WF_DM_USR'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZYKZ_C_WF_DM_USR-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZYKZ_C_WF_DM_USR_EXTRACT
TOTAL = ZYKZ_C_WF_DM_USR_TOTAL
